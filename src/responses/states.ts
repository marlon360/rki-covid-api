...
import {
  ...
  getStatesAgeGroups,
  AgeGroupsData,
  S_CasesChangesHistory,
  getStatesCasesChangesHistory,
...
interface StatesHistoryDataObj<T> extends IResponseMeta {
  data: T;
  meta: ResponseMeta;
}

export async function StatesCasesChangesHistoryResponse(
  stateId?: string,
  tillReportDate?: Date,
  oneReportDate?: Date,
  changeDate?: Date
