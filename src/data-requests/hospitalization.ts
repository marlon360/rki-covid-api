...
export async function getHospitalizationData(): Promise<ResponseData<HospitalizationData>> {
  const hospitalizationDataPromise = new Promise<HospitalizationData>(async (resolve, reject) => {
    // Create the parser
    const parser = parse({
      delimiter: ",",
      from: 2,
      ...
      while ((record = parser.read())) {
        ...
        switch (ageGroup) {
          case "00+":
            ...
            hospitalizationDataEntry.incidence7Days = parseFloat(incidence7days);
            break;
          default:
    ...
    parser.on("end", async function () {
      ...
      adjParser.on("readable", function () {
        ...
        while ((record = adjParser.read())) {
          ...
          if (id === "00") {
            hospitalizationDataObject[date].fixedCases7Days = parseInt(fixedCases7Days);
            hospitalizationDataObject[date].updatedCases7Days = parseInt(updatedCases7Days);
            hospitalizationDataObject[date].adjustedLowerCases7Days = parseInt(adjustedLowerCases7Days);
            hospitalizationDataObject[date].adjustedCases7Days = parseInt(adjustedCases7Days);
            hospitalizationDataObject[date].adjustedUpperCases7Days = parseInt(adjustedUpperCases7Days);
            hospitalizationDataObject[date].fixedIncidence7Days = parseFloat(fixedIncidence7Days);
            hospitalizationDataObject[date].updatedIncidence7Days = parseFloat(updatedIncidence7Days);
            hospitalizationDataObject[date].adjustedLowerIncidence7Days = parseFloat(adjustedLowerIncidence7Days);
            hospitalizationDataObject[date].adjustedIncidence7Days = parseFloat(adjustedIncidence7Days);
            hospitalizationDataObject[date].adjustedUpperIncidence7Days = parseFloat(adjustedUpperIncidence7Days);
          } else {
            hospitalizationDataObject[date].states[state].fixedCases7Days = parseInt(fixedCases7Days);
            hospitalizationDataObject[date].states[state].updatedCases7Days = parseInt(updatedCases7Days);
            hospitalizationDataObject[date].states[state].adjustedLowerCases7Days = parseInt(adjustedLowerCases7Days);
            hospitalizationDataObject[date].states[state].adjustedCases7Days = parseInt(adjustedCases7Days);
            hospitalizationDataObject[date].states[state].adjustedUpperCases7Days = parseInt(adjustedUpperCases7Days);
            hospitalizationDataObject[date].states[state].fixedIncidence7Days = parseFloat(fixedIncidence7Days);
            hospitalizationDataObject[date].states[state].updatedIncidence7Days = parseFloat(updatedIncidence7Days);
            hospitalizationDataObject[date].states[state].adjustedLowerIncidence7Days = parseFloat(adjustedLowerIncidence7Days);
            hospitalizationDataObject[date].states[state].adjustedIncidence7Days = parseFloat(adjustedIncidence7Days);
            hospitalizationDataObject[date].states[state].adjustedUpperIncidence7Days = parseFloat(adjustedUpperIncidence7Days);
          }
        }
      });
      // Catch any error
