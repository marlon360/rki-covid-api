...
> {
    ...
    const lastUpdate =
        lastModified != null ? new Date(lastModified) : new Date();
        ...
        if (entry.state == "Gesamt") {
            ...
            coverage.secondVaccination = {
                ...
                vaccination: {
                    ...
                    astraZeneca:
                        entry.VCfullAstraZeneca + entry.GPfullAstraZeneca,
                ...
                quote:
                    quoteEntry.quotefull === null
                        ? null
                        : quoteEntry.quotefull / 100.0,
            };
            coverage.indication = {
                age: null,
                job: null,
            ...
            coverage.states[abbreviation] = {
                ...
                quote:
                    quoteEntry.quote1 === null
                        ? null
                        : quoteEntry.quote1 / 100.0,
                secondVaccination: {
                    vaccinated: quoteEntry.totalfull,
                    vaccination: {
                        biontech: entry.VCfullbiontech + entry.GPfullbiontech,
