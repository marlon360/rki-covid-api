...
`GET http://api.fritz.box:8080/germany`
[Open](/germany)
...
`GET http://api.fritz.box:8080/germany/history/cases`
...
`GET http://api.fritz.box:8080/germany/history/cases/7`
[Open](/germany/history/cases)
...
`GET http://api.fritz.box:8080/germany/history/incidence`
...
`GET http://api.fritz.box:8080/germany/history/incidence/3`
...
`GET http://api.fritz.box:8080/germany/history/deaths`
...
`GET http://api.fritz.box:8080/germany/history/deaths/7`
...
`GET http://api.fritz.box:8080/germany/history/recovered`
...
`GET http://api.fritz.box:8080/germany/history/recovered/7`
...
`GET http://api.fritz.box:8080/germany/age-groups`
...
`GET http://api.fritz.box:8080/germany/history/frozen-incidence/7`
...
`GET http://api.fritz.box:8080/germany/history/hospitalization/7`
